  ...
  try {
    if (stream) {
      ...
      try {
        ...
        const alertPrefix = `> ⚠️ **Notice: Live OpenAI API Call failed.** (Reason: *${apiError.message}*)\n>\n> *Auto-falling back to Antigravity AI simulation mode so you can continue testing this UI! Go ahead and ask me for code, tables, or explanation questions.*\n\n`;
...
I am **Antigravity AI**, running in **developer simulation mode** because your \`.env\` file does not contain a valid \`OPENAI_API_KEY\`. 
